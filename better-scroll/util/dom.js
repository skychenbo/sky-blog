...
let tranform = prefixStyle('transform')
...
export const eventType = {
    ...
    mousedown: MOUSE_EVNET,
    mousemove: MOUSE_EVNET,
    mouseup: MOUSE_EVNET
}
...
export function click(e) {
    ...
    if (!(/(SELECT|INPUT|TEXTAREA)/i).test(target.tagName)) {
        ...
        // cancelable 设置为 false 是为了解决和 fastclick 冲突的问题
